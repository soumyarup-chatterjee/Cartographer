...
class ValidationException extends CGException implements ValidationEventHandler {

    @Override
    public boolean handleEvent(ValidationEvent validationEvent) {
        this.add(new Event(validationEvent), ActivityType.VALIDATION);
        return validationEvent.getSeverity() < 2;
    }

    @Override
    public void add(Event e) {
        super.add(e, ActivityType.VALIDATION);
    }
