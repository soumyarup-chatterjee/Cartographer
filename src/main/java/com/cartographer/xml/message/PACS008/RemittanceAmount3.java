 ...
 *       <sequence>
 *         <element name="DuePyblAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="DscntApldAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11}DiscountAmountAndType1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CdtNoteAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="TaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11}TaxAmountAndType1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AdjstmntAmtAndRsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.11}DocumentAdjustment1" maxOccurs="unbounded" minOccurs="0"/>
