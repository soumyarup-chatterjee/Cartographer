 ...
 *       <sequence>
 *         <element name="OrgnlMndtId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}Max35Text" minOccurs="0"/>
 *         <element name="OrgnlCdtrSchmeId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}PartyIdentification135" minOccurs="0"/>
 *         <element name="OrgnlCdtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="OrgnlCdtrAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}CashAccount40" minOccurs="0"/>
 *         <element name="OrgnlDbtr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}PartyIdentification135" minOccurs="0"/>
 *         <element name="OrgnlDbtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}CashAccount40" minOccurs="0"/>
 *         <element name="OrgnlDbtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}BranchAndFinancialInstitutionIdentification6" minOccurs="0"/>
 *         <element name="OrgnlDbtrAgtAcct" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}CashAccount40" minOccurs="0"/>
 *         <element name="OrgnlFnlColltnDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}ISODate" minOccurs="0"/>
 *         <element name="OrgnlFrqcy" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}Frequency36Choice" minOccurs="0"/>
 *         <element name="OrgnlRsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}MandateSetupReason1Choice" minOccurs="0"/>
 *         <element name="OrgnlTrckgDays" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}Exact2NumericText" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
