 ...
 *       <sequence>
 *         <element name="DuePyblAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="DscntApldAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}DiscountAmountAndType1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CdtNoteAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         <element name="TaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}TaxAmountAndType1" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="AdjstmntAmtAndRsn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12}DocumentAdjustment1" maxOccurs="unbounded" minOccurs="0"/>
